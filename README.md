...
A Claude Code skill for publishing scripts from ~/.claude/scripts/ to the HartreeWorks/claude-scripts repository.
...
```bash
npx skills add HartreeWorks/skill--share-scripts
```
